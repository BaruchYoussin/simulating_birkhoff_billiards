...
# This file is 4th (0-based) of the 6 files creating the separtrices for different starting points, so that together
...
# Max discrepancy: 2.576541974329742e-58
print(f"Completed! separatrix_path: {separatrix_path}")
# Completed! separatrix_path: ../../orbits/k3A0.5/separatrices/9down_left50_4/separatrix.pkl
