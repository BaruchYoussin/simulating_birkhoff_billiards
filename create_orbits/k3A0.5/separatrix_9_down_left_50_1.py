...
# This file is 1st (0-based) of the 6 files creating the separtrices for different starting points, so that together
...
# Max discrepancy: 2.417441599740362e-58
print(f"Completed! separatrix_path: {separatrix_path}")
# Completed! separatrix_path: ../../orbits/k3A0.5/separatrices/9down_left50_1/separatrix.pkl
