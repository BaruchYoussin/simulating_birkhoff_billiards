...
# create_orbits/k3A0.5/periodic_orbit_k3A0.5.py, in the downward left direction.
# Precision of the separatrix: 50 decimals achieved by working precision 110 decimals (validation: 130).
# Based on separatrix_9_down_left.py
# This file is 5th (0-based) of the 6 files creating the separtrices for different starting points, so that together
...
other_separatrix_direction = np.array([-1, 0.00093])  # the eigenvalue is 1.147, see periodic_orbit_k3A0.5.py
approach_separatrix_direction = np.array([-1, -0.00093])  # the eigenvalue is 0.87
forward = True
...
# Max discrepancy: 2.8343069016767656e-58
print(f"Completed! separatrix_path: {separatrix_path}")
# Completed! separatrix_path: ../../orbits/k3A0.5/separatrices/9down_left50_5/separatrix.pkl
